...
/**
 * DTO che rappresenta un rapporto di verifica della firma digitale di un documento.
 */
import java.util.Date;

import it.doqui.index.ecmengine.dto.EcmEngineDto;

public class VerifyReport extends EcmEngineDto{

	private static final long serialVersionUID = -4916677539057727189L;
	private String uid;
