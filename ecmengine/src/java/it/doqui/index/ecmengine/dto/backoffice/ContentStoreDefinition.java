...
/**
 * Classe che definisce le proprieta' di un ContentStore.
 *
 * @author Doqui
 */
public class ContentStoreDefinition extends EcmEngineDto {

    private static final long serialVersionUID = -5676456576875748406L;
