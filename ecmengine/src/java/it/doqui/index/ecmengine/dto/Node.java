 ...
 * @author Doqui
 */
public class Node extends EcmEngineDto {
	
	private static final long serialVersionUID = 8341625629578553353L;
	private String uid;
	...
	/**
	 * Controlla se l'oggetto {@code Node} specificato &egrave; uguale a questo 
	 * {@code Node}.
	 * 
	 * @param object Il nodo da controllare.
	 * 
	 * @return {@code true} se il nodo specificato corrisponde a questo nodo,
	...
	public boolean equals(Object object) {
		if (object instanceof Node) {
			...
			// TODO Decidere se includere la condizione sul repository.
			return (this == object 
					|| uid.equals(node.getUid()));
		}
