...
/**
 * DTO utilizzato per rappresentare un Tenant (repository logico) all'interno di ECMEngine.
 * @author Doqui
 */
import it.doqui.index.ecmengine.dto.EcmEngineDto;

public class Tenant extends EcmEngineDto {

	private static final long serialVersionUID = -5676173832325748406L;
