...
/**
 * Dictionary repository bootstrap esteso con supporto multi-repository.
 * 
 * @author DoQui
 */
public class DictionaryRepositoryBootstrap extends org.alfresco.repo.dictionary.DictionaryRepositoryBootstrap {
	...
	protected void onBootstrap(ApplicationEvent event) {
    	for (Repository repository : repositoryManager.getRepositories()) {
    		...
    		logger.info("[DictionaryRepositoryBootstrap::onBootstrap] " +
    				"Repository '" + RepositoryManager.getCurrentRepository() 
    				+ "' -- Executing dictionary repository bootstrap.");
