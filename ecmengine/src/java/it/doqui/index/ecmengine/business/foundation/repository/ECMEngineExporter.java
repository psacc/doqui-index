 ...
 */
public class ECMEngineExporter   implements Exporter
{
	 ...
	 */
	ECMEngineExporter(NamespaceService namespaceService, NodeService nodeService, SearchService searchService,
	...
	public void content(NodeRef nodeRef, QName property, InputStream content, ContentData contentData, int index)
	{
		try{
			...
			String ptemp=contentData.getMimetype()+"|"+contentData.getSize()+"|"+contentData.getEncoding()+"|";
