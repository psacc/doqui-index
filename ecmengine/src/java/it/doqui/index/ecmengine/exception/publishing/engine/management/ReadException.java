...
/**
 * Eccezione applicativa che rappresenta un errore in fase di lettura
 * di un contenuto sul repository dell'ECMENGINE.
 * 
 * @author Doqui.
 */
public class ReadException extends EcmEngineException {

	private static final long serialVersionUID = -1664513458784232036L;

	/**
	 * Costruisce una nuova istanza di {@code ReadException}.
	 * 
	...
	/**
	 * Costruisce una nuova istanza di {@code ReadException} associandovi
