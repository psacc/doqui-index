...
package it.doqui.index.ecmengine.exception.search;
...
extends EcmEngineFoundationException {
	 ...
	 *
	 */
	protected SearchRuntimeException() {
		super();
	}

	/**
	 * Costruisce una nuova istanza di <code>SearchRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 *
	 * @param code Il codice di errore.
	 */
	public SearchRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
