 ...
 * gestione dei nodi archiviati.</p>
 * 
 ...
 *
 */
public class NodeArchiveRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = 4643400828802618254L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected NodeArchiveRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>NodeRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public NodeArchiveRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
