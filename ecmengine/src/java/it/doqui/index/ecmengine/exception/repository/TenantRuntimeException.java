 ...
 *
 */
public class TenantRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = -4658631244626320836L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected TenantRuntimeException() {
		super();
	}

	/**
	 * Costruisce una nuova istanza di <code>TenantRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public TenantRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
