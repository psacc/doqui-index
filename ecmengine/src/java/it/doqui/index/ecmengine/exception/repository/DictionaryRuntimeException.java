 ...
 * dizionario del content model.</p>
 * 
 ...
 *
 */
public class DictionaryRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = -737617368654289532L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected DictionaryRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>DictionaryRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public DictionaryRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
