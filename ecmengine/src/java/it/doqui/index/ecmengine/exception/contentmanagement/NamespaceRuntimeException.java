 ...
 *
 */
public class NamespaceRuntimeException extends EcmEngineFoundationException {
	 ...
	 *
	 */
	protected NamespaceRuntimeException() {
		super();
	}
	 ...
	 */
	public NamespaceRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
