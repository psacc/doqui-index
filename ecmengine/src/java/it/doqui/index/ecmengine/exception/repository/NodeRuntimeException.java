 ...
 *
 */
public class NodeRuntimeException extends EcmEngineFoundationException {
	 ...
	 *
	 */
	protected NodeRuntimeException() {
		super();
	}
	 ...
	 */
	public NodeRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
