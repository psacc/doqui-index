 ...
 *
 */
public class CopyRuntimeException extends EcmEngineFoundationException {
	 ...
	 *
	 */
	protected CopyRuntimeException() {
		super();
	}
	 ...
	 */
	public CopyRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
