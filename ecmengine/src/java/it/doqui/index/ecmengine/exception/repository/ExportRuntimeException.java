 ...
 *
 */
public class ExportRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = 4643400828802618255L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected ExportRuntimeException() {
		super();
	}
	 ...
	 */
	public ExportRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
	
	public ExportRuntimeException(String msg){
		super(msg);
	}
}
