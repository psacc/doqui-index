 ...
 *
 */
public class AuthorityRuntimeException extends EcmEngineFoundationException {
	
	private static final long serialVersionUID = -1816108354052879731L;
	
	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected AuthorityRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>AuthorityRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public AuthorityRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
