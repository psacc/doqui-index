 ...
 *
 */
public class AuditRuntimeException extends EcmEngineFoundationException {


	/**
	 * 
	 */
	private static final long serialVersionUID = -7711981126000307841L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected AuditRuntimeException() {
		super();
	}

	/**
	 * Costruisce una nuova istanza di <code>AuditRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public AuditRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
