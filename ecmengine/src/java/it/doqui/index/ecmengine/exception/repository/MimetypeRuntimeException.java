 ...
 *
 */
public class MimetypeRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = -4839138980398980098L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected MimetypeRuntimeException() {
		super();
	}
	 ...
	 */
	public MimetypeRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
