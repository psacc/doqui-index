 ...
 *
 */
public class PersonRuntimeException extends EcmEngineFoundationException {
	
	private static final long serialVersionUID = 357712425539470693L;
	
	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected PersonRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>PersonRuntimeException</code>
	 * con il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public PersonRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
