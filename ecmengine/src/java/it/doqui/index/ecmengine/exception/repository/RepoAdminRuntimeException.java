 ...
 *
 */
public class RepoAdminRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = -58155917597458320L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected RepoAdminRuntimeException() {
		super();
	}

	/**
	 * Costruisce una nuova istanza di <code>RepoAdminRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public RepoAdminRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
