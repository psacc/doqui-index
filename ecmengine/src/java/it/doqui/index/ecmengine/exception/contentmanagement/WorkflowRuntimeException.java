 ...
 *
 */
public class WorkflowRuntimeException extends EcmEngineFoundationException {


	private static final long serialVersionUID = 1523131035595396238L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected WorkflowRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>CopyRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public WorkflowRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
