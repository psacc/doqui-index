 ...
 * o ricerca nella tabella dell'audit trail dell'ECMENGINE.
 * 
 * @author Doqui.
 */

public class AuditTrailException extends EcmEngineException {

	private static final long serialVersionUID = 1026010344459546707L;

	/**
	 * Costruisce una nuova istanza di {@code AuditTrailException}.
	 * 
	...
	/**
	 * Costruisce una nuova istanza di {@code AuditTrailException} associandovi
