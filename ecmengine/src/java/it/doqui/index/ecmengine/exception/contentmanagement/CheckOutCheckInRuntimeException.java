 ...
 *
 */
public class CheckOutCheckInRuntimeException extends EcmEngineFoundationException {
	
	private static final long serialVersionUID = 3833980826766830850L;
	
	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected CheckOutCheckInRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>CheckOutCheckInRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public CheckOutCheckInRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
