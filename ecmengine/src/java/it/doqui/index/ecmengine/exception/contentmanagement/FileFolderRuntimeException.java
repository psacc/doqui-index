 ...
 *
 */
public class FileFolderRuntimeException extends EcmEngineFoundationException {
	 ...
	 *
	 */
	protected FileFolderRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>FileFolderRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public FileFolderRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
