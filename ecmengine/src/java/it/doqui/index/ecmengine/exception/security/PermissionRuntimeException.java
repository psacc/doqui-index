 ...
 *
 */
public class PermissionRuntimeException extends EcmEngineFoundationException {
	
	private static final long serialVersionUID = -6635164926276190387L;
	
	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected PermissionRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>PermissionRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public PermissionRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
