 ...
 *
 */
public class LockRuntimeException extends EcmEngineFoundationException {
	 ...
	 *
	 */
	protected LockRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>LockRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public LockRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
