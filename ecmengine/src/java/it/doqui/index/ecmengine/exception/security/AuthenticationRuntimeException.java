 ...
 *
 */
public class AuthenticationRuntimeException extends EcmEngineFoundationException {	
	 ...
	 *
	 */
	protected AuthenticationRuntimeException() {
		super();
	}
	
	/**
	 * Costruisce una nuova istanza di <code>AuthenticationRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public AuthenticationRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
