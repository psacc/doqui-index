...
/**
 * Eccezione applicativa che rappresenta un errore in fase di cancellazione
 * di un contenuto sul repository dell'ECMENGINE.
 * 
 * @author Doqui.
 */

public class DeleteException extends EcmEngineException{
	...
	/**
	 * Costruisce una nuova istanza di {@code DeleteException}.
	 * 
	...
	/**
	 * Costruisce una nuova istanza di {@code DeleteException} associandovi
