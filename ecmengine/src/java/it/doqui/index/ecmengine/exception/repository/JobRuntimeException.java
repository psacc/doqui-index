 ...
 *
 */
public class JobRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = -4839138176025425098L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected JobRuntimeException() {
		super();
	}

	/**
	 * Costruisce una nuova istanza di <code>JobRuntimeException</code>
	 * associandovi il codice di errore specificato.
	 * 
	 * @param code Il codice di errore.
	 */
	public JobRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
