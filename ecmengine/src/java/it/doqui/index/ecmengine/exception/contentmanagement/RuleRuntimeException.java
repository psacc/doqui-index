...
public class RuleRuntimeException extends EcmEngineFoundationException {

	private static final long serialVersionUID = 6155756832094869950L;

	/**
	 * Costruttore di default richiamabile dalle sottoclassi.
	 *
	 */
	protected RuleRuntimeException() {
		super();
	}
	 ...
	 */
	public RuleRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
