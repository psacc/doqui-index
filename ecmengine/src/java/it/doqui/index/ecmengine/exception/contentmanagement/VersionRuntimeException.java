 ...
 *
 */
public class VersionRuntimeException extends EcmEngineFoundationException {
	 ...
	 *
	 */
	protected VersionRuntimeException() {
		super();
	}
	 ...
	 */
	public VersionRuntimeException(FoundationErrorCodes code) {
		super(code);
	}
}
