...
/**
 * Eccezione applicativa che rappresenta un errore in fase di modifica
 * di un contenuto sul repository dell'ECMENGINE.
 * 
 * @author Doqui.
 */
public class UpdateException extends EcmEngineException {

	private static final long serialVersionUID = -7909918354126785352L;

	/**
	 * Costruisce una nuova istanza di {@code UpdateException}.
	 * 
	...
	/**
	 * Costruisce una nuova istanza di {@code UpdateException} associandovi
