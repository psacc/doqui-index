...
public class TestEngine extends TestCase implements EcmEngineWebservicesTestConstants {
	...
	public TestEngine(String name) {
		...
		try {
			...
			log.error("[TestEngine::Constructor] Instantiation EcmEngine problem", e);
		}
