...
public class AllTests extends TestCase implements EcmEngineTestConstants {
  ...
  public static Test suite() {
	...
	suite.addTestSuite(it.doqui.index.ecmengine.test.TestBackoffice.class);
	suite.addTestSuite(it.doqui.index.ecmengine.test.TestEngine.class);
	suite.addTestSuite(it.doqui.index.ecmengine.test.TestMassive.class);
	suite.addTestSuite(it.doqui.index.ecmengine.test.TestSecurity.class);
    return suite;
  }
